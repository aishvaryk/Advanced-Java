...
public class BankAccount {
	...
	public BankAccount(int accountNumber, String name,String password, double amount,String accountType) {
		...
		if (accountType=="savings") {
			interestRate = BankAccountTypes.SavingsAccount.getInterestRate();
			minimumBalance = BankAccountTypes.SavingsAccount.getMinimumBalance();
			isOverDrafting =  BankAccountTypes.SavingsAccount.isOverDrafting();
			overDraftingFees = 0;
		}
		
		else if (accountType=="current") {
			interestRate = BankAccountTypes.CurrentAccount.getInterestRate();
			minimumBalance = BankAccountTypes.CurrentAccount.getMinimumBalance();
