...
public class Assignment8_1Specs {
	...
	public void searchCanReturnAllCurrentAccounts() {
		...
		selectedAccounts= Search.searchTypeCurrentAccount(selectedAccounts); //search for current accounts
	...
	public void searchCanReturnAccountWithNegativeBalance() {
		selectedAccounts=Search.searchAccountWithNegativeBalance(accounts); //search for accounts with negative balance
	...
	public void searchCanReturnAllAccountWithLastNameMishra() {
		selectedAccounts=Search.searchAccountWithLastName(accounts, "Mishra");
